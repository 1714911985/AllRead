...
public class PdfSelectedFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (viewMethodId == R.id.bdrb_list) {
            ...
            rvPdfSelected.setLayoutManager(new LinearLayoutManager(requireActivity()));
        } else {
            //grid
                    ...
                    public void run() {
                        if (viewMethodId == R.id.bdrb_grid) {
                            ...
                            if (originViewMethodId == R.id.bdrb_grid) {
                                ...
                                rvPdfSelected.setLayoutManager(new LinearLayoutManager(requireActivity())); // 确保布局管理器被设置
